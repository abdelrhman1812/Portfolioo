...
function Aside() {
  ...
  useEffect(() => {
    ...
    spans.forEach((span) => {
      span.addEventListener("click", function () {
        ...
        //this Loop To remove Active From Span and Chheck section Have active or no
  ...
  function showSection(element) {
    let targt = element.getAttribute("section");
    let section = document.getElementById(targt);
  ...
  return (
    <aside ref={aside} id="aside">
      <div className="logo">
        <Link>
          <img src={require("../../Assets/images/ody.jpg")} alt="" />
        </Link>
      </div>
